...
public static class CheckoutManagerEvents
{
    #region Payment
    /// <summary>
    /// Fired when a payment operation is completed. 
    /// Subscribers receive the checkout manager instance and the payment amount.
    /// </summary>
    ...
    /// <summary>
    /// Fired when payment is taken from the customer. 
    /// Subscribers receive the checkout manager instance.
    /// </summary>
    ...
    /// <summary>
    /// Fired when cash payment is taken from the customer. 
    /// Subscribers receive the checkout manager instance.
    /// </summary>
    ...
    /// <summary>
    /// Fired when card payment is taken from the customer. 
    /// Subscribers receive the checkout manager instance.
    /// </summary>
    ...
    /// <summary>
    /// Fired when a product is scanned at the checkout. 
    /// Subscribers receive the checkout manager instance and the scanned product.
    /// </summary>
    ...
    /// <summary>
    /// Fired when products are placed on the checkout counter. 
    /// Subscribers receive the checkout manager instance and the list of placed products.
    /// </summary>
    ...
    /// <summary>
    /// Fired when scanned products are moved to the customer's bag. 
    /// Subscribers receive the checkout manager instance, the list of products being bagged.
    /// </summary>
    ...
    /// <summary>
    /// Fired when a customer joins the checkout queue. 
    /// Subscribers receive the checkout manager instance and the customer that joined.
    /// </summary>
    ...
    /// <summary>
    /// Fired when a customer leaves the checkout queue. 
    /// Subscribers receive the checkout manager instance.
    /// </summary>
    ...
    /// <summary>
    /// Fired when the checkout status changes. 
    /// Subscribers receive the checkout manager instance.
    /// </summary>
